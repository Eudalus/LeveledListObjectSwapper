...
namespace Data
{
    ...
    */
    ...
    // ----- COMBINED GENERATE PROTOCOLS -----
    inline const std::uint16_t VALID_MULTI_PROTOCOL_COMBINED_GENERATE_SWAP_MIN = 1070;
    inline const std::uint16_t VALID_MULTI_PROTOCOL_COMBINED_GENERATE_SWAP_LIST_OUTFIT_CONTAINER = 1070; // protocols 170, 450, 750
    inline const std::uint16_t VALID_MULTI_PROTOCOL_COMBINED_GENERATE_SWAP_LIST_OUTFIT = 1071; // protocols 170, 450
    inline const std::uint16_t VALID_MULTI_PROTOCOL_COMBINED_GENERATE_SWAP_LIST_CONTAINER = 1072; // protocols 170, 750
    inline const std::uint16_t VALID_MULTI_PROTOCOL_COMBINED_GENERATE_SWAP_OUTFIT_CONTAINER = 1073; // protocols 450, 750
    inline const std::uint16_t VALID_MULTI_PROTOCOL_COMBINED_GENERATE_SWAP_MAX = 1073;
